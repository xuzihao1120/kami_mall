...
//    }
    ...
    public static void main(String[] args, byte[] bytes1) throws IOException {
//         自定义参数
        CaptchaUtil code = new CaptchaUtil(100, 30, 4, 10);
//        String sessionId = session.getId();
//        RedisUtil.set("captcha_" + sessionId, code.getCode(), 60 * 30);
//        FileOutputStream fileOutputStream = new FileOutputStream(new File("a.txt"));
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        code.write(baos);
        String s = Base64Utils.encodeToString(baos.toByteArray());
